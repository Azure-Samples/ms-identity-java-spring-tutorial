...
Write-Host "You may want to remove the security group 'AdminGroup' if it was created to test this sample only."

# if($null -ne (Get-AzureADGroup -SearchString AdminGroup)) {
#   Remove-AzureADGroup -ObjectId (Get-AzureADGroup -SearchString AdminGroup).objectId
# }
Write-Host "You may want to remove the security group 'UserGroup' if it was created to test this sample only."

# if($null -ne (Get-AzureADGroup -SearchString UserGroup)) {
#   Remove-AzureADGroup -ObjectId (Get-AzureADGroup -SearchString UserGroup).objectId
# }
