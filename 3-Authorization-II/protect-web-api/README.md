...
- [About the code](#about-the-code)
  ...
  - [Validate your Azure access tokens using routes with AADDelegatingOAuth2TokenValidator](#validate-your-azure-access-tokens-using-routes-with-aaddelegatingoauth2tokenvalidator)
- [How to deploy this sample to Azure](#how-to-deploy-this-sample-to-azure)
  - [Deploying Web API to Azure App Services](#deploying-web-api-to-azure-app-services)
  - [Deploying the Web app to Azure App Service](#deploying-the-web-app-to-azure-app-service)
...
This sample demonstrates a Java Spring web application calling a Java Spring web API that is secured using Azure AD. It uses the [Azure AD Spring Boot Starter client library for Java](https://github.com/Azure/azure-sdk-for-java/tree/master/sdk/spring/azure-spring-boot-starter-active-directory).
