...
Function ConfigureApplications
{
   ...
   $serviceAadApplication = New-MgApplication -DisplayName "java-spring-webapi-auth" `
    ...
    Write-Host "Successfully registered and configured that app registration for 'java-spring-webapi-auth' at `n $servicePortalUrl" -ForegroundColor Red 
   ...
   $clientAadApplication = New-MgApplication -DisplayName "java-spring-webapp-auth" `
    ...
    # print the registered app portal URL for any further navigation
    Write-Host "Successfully registered and configured that app registration for 'java-spring-webapp-auth' at `n $clientPortalUrl" -ForegroundColor Red 
