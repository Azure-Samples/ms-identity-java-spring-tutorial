...
Function ConfigureApplications
{
   ...
   $webAppAadApplication = New-MgApplication -DisplayName "java-spring-webapp-auth" `
                                                      -Web `
                                                      @{ `
    ...
    Update-MgApplication -ApplicationId $webAppAadApplication.Id -IdentifierUris @("https://$tenantName/java-spring-webapp-auth")
